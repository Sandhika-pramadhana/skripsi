pipeline {
  ...
  environment {
    ...
    GOOGLE_CLIENT_EMAIL = "spreadsheet@dashboardmonitoring-449816.iam.gserviceaccount.com"
    ...
    -----END PRIVATE KEY-----'''
    GOOGLE_SHEET_ID = "1zdBm8DnsTXdrYKjaXLBdEeCPJ2JiIJQUOuTHiMdlWlI"
    ENCRYPTION_KEY = "WtBlLiX/DbRsSsy2Qmw1iynkKpH8M7v149um7xZ6NoU="

    NEXT_PUBLIC_API_URL = "https://api-kurir.posfin.id/api/v1"
    NEXT_PUBLIC_API_URL_SANDBOX = "https://sandboxkurir.posfin.id/api/v1"
    NEXT_PUBLIC_X_API_TOKEN = "SuRyptU70wsIGfshdZDEEGPv1eTh0bN4FLE3C84MdtOo8AwlpkuvKzI9nfaNuavX"
    NEXT_PUBLIC_SECRET = "c58a4b1b41d66baa51f6f31a5d2b60422a6c58b4f70d2e223d98319bbc27377f"
    NEXT_PUBLIC_JWT_SECRET = "d336f50a782bbbb20914d20883046c462de51c28b4f6c2c27aca8e21509b04b0"
  }
      ...
      steps {
        script {
          ...
          sh """
            ...
            -e NEXT_PUBLIC_API_URL_SANDBOX=$NEXT_PUBLIC_API_URL_SANDBOX \
            -e NEXT_PUBLIC_X_API_TOKEN=$NEXT_PUBLIC_X_API_TOKEN \
            -e NEXT_PUBLIC_SECRET=$NEXT_PUBLIC_SECRET \
            -e NEXT_PUBLIC_JWT_SECRET=$NEXT_PUBLIC_JWT_SECRET \
