...
import { getListCallbacks } from "@/actions/sandbox/tsel/callbacks-tsel/callbacks";
import { FilterCallbacksSection } from "./filter";
...
export function ListCallbacks() {
  ...
  const swrKey = useMemo(() => 
    `listCallbacks-${termDebounced}-${typeNameDebounced}-${startDate}-${endDate}-${pagination.pageIndex}-${pagination.pageSize}`,
  ...
  return (
    <main className="p-12 pb-4 border mt-3 rounded-lg shadow-sm bg-white">
      <div className="flex justify-between">
        <h1 className="text-3xl font-bold mb-4">Daftar Callbacks Tsel</h1>
      </div>
