...
import { getListLogApisMandiri } from "@/actions/sandbox/mandiri/log-apis-mandiri/log-apis";
import { FilterLogApisMandiriSection } from "./filter";
...
export function ListLogApisMandiri() {
  const [preference, savePreference] = useLocalStorage<Preference>(
    "list-log-apis-mandiri-preference",
    preferenceInit
  );
  ...
  return (
    <main className="p-12 pb-4 border mt-3 rounded-lg shadow-sm bg-white">
      <div className="flex justify-between">
        <h1 className="text-3xl font-bold mb-4">Daftar Log APIs Mandiri</h1>
      </div>
...
export default ListLogApisMandiri;