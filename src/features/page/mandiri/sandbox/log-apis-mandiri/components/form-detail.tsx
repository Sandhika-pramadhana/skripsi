...
interface FormDetailLogApiMandiriProps {
  open: boolean;
  onOpenModal: (open: boolean) => void;
  data?: LogApis;
}

const FormDetailLogApiMandiri: React.FC<FormDetailLogApiMandiriProps> = ({
  open,
  onOpenModal,
  data,
}) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenModal}>
      <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Detail Log API Mandiri</DialogTitle>
        </DialogHeader>
...
export default FormDetailLogApiMandiri;
