...
export default function LogApisMandiriSection({ children }: { children: React.ReactNode }) {
  return (
    <SidebarProvider>
      {/* Sidebar */}
      <AppSidebar />
        ...
        <main className="flex-1 p-4">
          ...
          <div className="flex items-center justify-between">
            <div className="flex gap-2 items-center">
              <DatabaseIcon />
              <h1 className="font-bold text-2xl my-4">Data Log APIs Mandiri</h1>
            </div>
          </div>

          {/* List Log APIs Mandiri */}
          <ListLogApisMandiri />
        </main>
      </div>
    </SidebarProvider>
