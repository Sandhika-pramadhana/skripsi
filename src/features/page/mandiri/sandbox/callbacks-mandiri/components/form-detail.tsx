...
interface FormDetailCallbackMandiriProps {
  open: boolean;
  onOpenModal: (open: boolean) => void;
  data?: callbacks;
}

const FormDetailCallbackMandiri: React.FC<FormDetailCallbackMandiriProps> = ({
  open,
  onOpenModal,
  data,
}) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenModal}>
      <DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Detail Callback Order Mandiri</DialogTitle>
        </DialogHeader>
...
export default FormDetailCallbackMandiri;