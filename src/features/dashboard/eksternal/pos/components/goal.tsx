...
const GoalExternalPosSection = ({ startDate, endDate} : TanggalType) => {
  ...
  const chartData = [
    { tipe: "kiriman", jumlah: totalKiriman, fill: "var(--color-kiriman)" },
...
export default GoalExternalPosSection;
