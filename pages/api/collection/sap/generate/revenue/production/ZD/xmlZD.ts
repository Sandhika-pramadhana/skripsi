  ...
  try {
    ...
    for (const currentDate of allDates) {
      try {
        ...
        // ✅ SOAP FORMAT SAMA PERSIS DENGAN SANDBOX
...
<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/">
  ...
  <soapenv:Body>
    <dws:setTransaction xmlns:dws="http://dwssync_pfi_prd" xmlns:xsd="http://dwssync_pfi_prd/xsd">
      <dws:input>`;
        ...
        <xsd:ITEM>
          ...
          <xsd:ZUONR>REVENUE-AGNPB</xsd:ZUONR>
          <xsd:KOSTL></xsd:KOSTL>
          <xsd:WWPRD></xsd:WWPRD>
      ...
      <dws:type>JSON</dws:type>
        ...
        // Save XML file
        const xmlname = `ZD_Revenue_AGNPB-${startDateFormatted}.xml`;
        ...
        // API CALL - SOAP 1.1 HEADERS SAMA DENGAN SANDBOX
        ...
        try {
          ...
          if (!response.ok) {
            ...
            // Parse response - SAMA DENGAN SANDBOX
    ...
    return res.status(500).json({
      success: false,
      error: error.message || 'Failed to generate XML ZD (Production)',
