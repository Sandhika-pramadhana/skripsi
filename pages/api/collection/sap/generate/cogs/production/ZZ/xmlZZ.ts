      ...
      try {
        ...
        if (datas.length === 0) {
          results.push({
            ...
            environment,
            status: 'skipped',
            message: 'No ZZ data found for this date',
          });
          continue;
        }
    ...
    <dws:setTransaction xmlns:dws="http://dwssync_pfi_prd" xmlns:xsd="http://dwssync_pfi_prd/xsd">
      <dws:input>`;
        ...
        <xsd:ITEM>
          ...
          <xsd:NEWKO>5100201000</xsd:NEWKO>
          ...
          <xsd:ZUONR>COGS-AGG</xsd:ZUONR>
          <xsd:KOSTL>CFI1370000</xsd:KOSTL>
          <xsd:WWPRD>12200111</xsd:WWPRD>
          <xsd:KUNNR></xsd:KUNNR>
          <xsd:SGTXT>COGS AGGREGATOR</xsd:SGTXT>
          <xsd:STATE></xsd:STATE>
        </xsd:ITEM>`;
        }
